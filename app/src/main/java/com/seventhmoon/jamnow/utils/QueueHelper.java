...
import com.seventhmoon.jamnow.VoiceSearchParams;
...
import static com.seventhmoon.jamnow.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
...
public class QueueHelper {
    ...
    public static List<MediaSessionCompat.QueueItem> getPlayingQueueFromSearch(String query,
        ...
        Log.d(TAG, "VoiceSearchParams: "+ params);
